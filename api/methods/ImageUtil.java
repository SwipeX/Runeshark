...
public class ImageUtil {
	...
	/**
	 * Gets whether a larger image contains a smaller image or not by a given
	 * threshold.
	 * 
	 * @param large
	 *            The large, parent image.
	 * @param small
	 *            The small image to search for in the large image.
	 * @param threshold
	 *            The image distance threshold, ranging between 0.0 and 1.0.
	...
	/**
	 * Gets whether a larger image contains an exact match of a smaller image or
	 * not.
	 * 
	 * @param large
	 *            The large, parent image.
	...
	/**
	 * Gets whether the sub image of a larger image contains a smaller image by
	...
	/**
	 * Gets whether the sub image of a larger image contains an exact match of a
	 * smaller image or not.
	 * 
	 * @param large
	 *            The large, parent image.
	 * @param x
	...
	/**
	 * Gets all points within an image which have a color within threshold
	 * distance of a given color.
	 * 
	 * @param image
	 *            The image to scan.
	 * @param bounds
	 *            The bounds to scan within.
	 * @param color
	...
	/**
	 * Gets all points within an image which have a color equal to a given
	 * color.
	 * 
	 * @param image
	 *            The image to scan.
